...
Before upgrading the Evmos version. Stop your instance of `cascadiad` using `Ctrl/Cmd+C`.
...
::: tip
If the software version does not match, then please check your `$PATH` to ensure the correct `cascadiad` is running.
:::
