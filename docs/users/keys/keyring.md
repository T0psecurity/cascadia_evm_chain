...
MY_VALIDATOR_ADDRESS=$(cascadiad keys show mykey -a)
```
...
yes $KEYPASSWD | cascadiad keys add me
yes $KEYPASSWD | cascadiad keys show me
# start cascadiad with keyring-backend flag
cascadiad --keyring-backend=file start
```
